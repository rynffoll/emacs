...
- [[#tabs][Tabs]]
  ...
  - [[#otpp][otpp]]
  - [[#tab-bar-mark][tab-bar-mark]]
  - [[#tab-bar-theme][tab-bar-theme]]
  - [[#tab-bar-indicator][tab-bar-indicator]]
  - [[#tab-bar-tree][tab-bar-tree]]
  - [[#per-tab-group-theme][per-tab-group-theme]]
  - [[#tab-line][tab-line]]
  - [[#tab-line-theme][tab-line-theme]]
  - [[#tab-line-nerd-icons][tab-line-nerd-icons]]
- [[#windows][Windows]]
  - [[#window][window]]
  - [[#winum][winum]]
  - [[#zoom][zoom]]
...
- [[#terminal][Terminal]]
  ...
  - [[#consult-ghostel][consult-ghostel]]
- [[#git][Git]]
  - [[#vc][vc]]
  - [[#ediff][ediff]]
  - [[#magit][magit]]
  - [[#magit-blame][magit-blame]]
  - [[#magit-worktree][magit-worktree]]
...
#+begin_example
┌─────┬───────┬──────┬────────┬─────┬───────────────┬───────┬──────┬─────────┬────┬──────┬───────┐
│ pin │ winum │ evil │ buffer │ pos │       →       │ debug │ misc │ flymake │ vc │ icon │ modes │
└─────┴───────┴──────┴────────┴─────┴───────────────┴───────┴──────┴─────────┴────┴──────┴───────┘
#+end_example
