...
** gptel-commit
Fetch Zed editor's [[https://github.com/zed-industries/zed/blob/main/crates/git_ui/src/commit_message_prompt.txt][commit message prompt]] style
#+begin_src sh :tangle no :results file :output-dir prompts/ :file commit_message_prompt.txt
curl -fsSL 'https://github.com/zed-industries/zed/blob/main/crates/git_ui/src/commit_message_prompt.txt?raw=1'
#+end_src

#+results:
[[file:prompts/commit_message_prompt.txt]]
