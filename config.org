...
#+begin_src sh :tangle no :results replace raw
echo "#+name: zed-commit-message-prompt"
echo "#+begin_src text"
...
#+results:
#+name: zed-commit-message-prompt
#+begin_src text
...
(use-package gptel-commit
  ...
  (setq gptel-commit-prompt "<<zed-commit-message-prompt>>"))
#+end_src
